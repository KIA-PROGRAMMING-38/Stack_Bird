...
public class ObjectPooler : MonoBehaviour
{
    ...
    static List<GameObject> spawnObjects;
    ...
    public static void SetOrderInLayer()
    {
        ...
        for (int i = 0; i < spawnObjects.Count; i++)
        {
            ...
            if (!spawnObjects[i].activeInHierarchy)
                continue;

            sortedList.Add(spawnObjects[i].transform.position.y, spawnObjects[i].GetComponent<SpriteRenderer>());
        }
